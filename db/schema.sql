...
CREATE TABLE classes (id INT NOT NULL AUTO_INCREMENT, name VARCHAR(100) NOT NULL, code CHAR(7) NOT NULL, semester VARCHAR(20) NOT NULL, availableSpaces INT NOT NULL, description VARCHAR(1000) NOT NULL, PRIMARY KEY(ID));
